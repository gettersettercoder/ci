          <ul id="slide-out" class="side-nav leftside-navigation ps-container ps-active-y" style="transform: translateX(-100%);">
            <li class="no-padding">
              <ul class="collapsible" data-collapsible="accordion">
                <li class="bold">
                  <a class="collapsible-header waves-effect waves-cyan">
                    <i class="material-icons">assignment</i>
                    <span class="nav-text"><?php echo lang('enquiries'); ?></span>
                  </a>
                  <div class="collapsible-body">
                    <ul>
                      <li>
                        <a href="<?php echo SITE_URL.'enquiry/'.$this->myvalues->enquiryDetails['controller'].'/view'; ?>">
                          <i class="material-icons">keyboard_arrow_right</i>
                          <span><?php echo lang('general_enquiry'); ?></span>
                        </a>
                      </li>
                      <li>
                        <a href="dashboard-analytics.html">
                          <i class="material-icons">keyboard_arrow_right</i>
                          <span><?php echo lang('addmission_enquiry'); ?></span>
                        </a>
                      </li>
                    </ul>
                  </div>
          ...
          <div class="ps-scrollbar-x-rail" style="left: 0px; bottom: 3px;"><div class="ps-scrollbar-x" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; height: 930px; right: 3px;"><div class="ps-scrollbar-y" style="top: 0px; height: 714px;"></div></div></ul>
