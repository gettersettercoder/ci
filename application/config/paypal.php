 ...
 *
 */
//$config['APIUsername'] = $config['Sandbox'] ? 'shakti.cmexpertise_api1.gmail.com' : 'PRODUCTION_USERNAME_GOES_HERE';
//$config['APIPassword'] = $config['Sandbox'] ? 'CSJTRXND7DVJUH7A' : 'PRODUCTION_PASSWORD_GOES_HERE';
//$config['APISignature'] = $config['Sandbox'] ? 'AsLp6CQ-tsdETWQ40MkSKR-p8oM.AETMrnLml4IUJWd6wjNSpG5UgqJZ' : 'PRODUCTION_SIGNATURE_GOES_HERE';

$config['APIUsername'] = $config['Sandbox'] ? 'abhishek.cmexpertise+7_api1.gmail.com' : 'PRODUCTION_USERNAME_GOES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? '6G58J795F9M8Q5NL' : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'Av-C-N2mzjF0ocZIm5IyKCc-fDTBAWEa.66CQl3fG859ePlxkHahYE0v' : 'PRODUCTION_SIGNATURE_GOES_HERE';
 ...
 */
$config['DeveloperEmailAccount'] = 'abhishek.cmexpertise@gmail.com';
